          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <radialGradient id="eduBG" cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="#43F5FF" stopOpacity="0.06" />
            ...
            <g className="origin-center animate-[spin_90s_linear_infinite]" style={{ transformOrigin: "50% 50%" }}>
              <line x1="15%" y1="20%" x2="35%" y2="40%" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="1" strokeDasharray="5 5" />
              <line x1="35%" y1="40%" x2="55%" y2="15%" stroke="rgba(58, 123, 255, 0.15)" strokeWidth="1" />
              <line x1="55%" y1="15%" x2="75%" y2="35%" stroke="rgba(67, 245, 255, 0.2)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="75%" y1="35%" x2="92%" y2="20%" stroke="rgba(58, 123, 255, 0.15)" strokeWidth="1.2" />
              <line x1="35%" y1="40%" x2="65%" y2="65%" stroke="rgba(67, 245, 255, 0.1)" strokeWidth="1" />
              <line x1="65%" y1="65%" x2="85%" y2="50%" stroke="rgba(58, 123, 255, 0.15)" strokeWidth="1" />
              
              <circle cx="15%" cy="20%" r="3" fill="#43F5FF" className="animate-pulse" />
              <circle cx="35%" cy="40%" r="4" fill="#3A7BFF" />
              <circle cx="55%" cy="15%" r="3.5" fill="#43F5FF" />
              <circle cx="75%" cy="35%" r="4" fill="#3A7BFF" className="animate-pulse" />
              <circle cx="92%" cy="20%" r="3" fill="#43F5FF" />
              <circle cx="65%" cy="65%" r="5" fill="#3A7BFF" />
              <circle cx="85%" cy="50%" r="3.5" fill="#43F5FF" />
            </g>
          </svg>
        </div>
