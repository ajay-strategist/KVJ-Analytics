            ...
            <Card hoverLift={false} className="border border-[#10B981]/25 bg-[#10B981]/5 p-6 rounded-2xl relative overflow-hidden">
              ...
              <form onSubmit={handleUnlockSubmit} className="flex gap-2 mt-4">
                ...
                <Button
                  ...
                  className="py-2.5 px-5 bg-gradient-to-r from-[#10B981] to-[#0D9488] text-black font-extrabold text-xs border-none flex items-center justify-center shrink-0"
                >
                        ...
                        <div className="flex gap-4 items-center">
                          <div className="w-14 h-14 rounded-xl overflow-hidden shrink-0 border border-line bg-surface hidden sm:block">
                            {course.banner_url ? (
                              ...
                              <div className="w-full h-full bg-zinc-900 flex items-center justify-center text-[#10B981]">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                          {isUnlocked ? (
                            <Link href={`/training/${course.slug}/learn`}>
                              <Button className="py-2 px-4 bg-[#10B981] text-black font-bold text-xs border-none flex items-center gap-1">
                                Launch Program
                              </Button>
                            </Link>
                          ) : (
                ...
                <Card hoverLift={false} className="card-tone-emerald border border-line p-8 rounded-3xl backdrop-blur-xl">
                  ...
                  <form onSubmit={handleInquirySubmit} className="space-y-4">
                    ...
                    <Button
                      ...
                      className="w-full py-3.5 bg-gradient-to-r from-[#10B981] to-[#0D9488] text-black font-extrabold flex items-center justify-center gap-1.5 border-none"
                    >
                      {inquiryLoading ? (
