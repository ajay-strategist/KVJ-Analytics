                    ...
                    <tr key={c.id} className="hover:bg-surface/30 transition-colors">
                      ...
                      <td className="p-4">
                        <div className="flex items-center justify-center gap-2">
                          <a href={`/training/${c.slug}`} target="_blank" rel="noreferrer" title="Preview the course landing page students see">
                            <Button
                              variant="ghost"
                          ...
                          <a href={`/training/${c.slug}/learn?preview=1`} target="_blank" rel="noreferrer" title="Open the course materials as an enrolled student sees them — no payment needed">
                            <Button
                              variant="ghost"
                              className="py-1.5 px-3 text-xs border border-line text-slate hover:text-brand flex items-center gap-1"
                            >
