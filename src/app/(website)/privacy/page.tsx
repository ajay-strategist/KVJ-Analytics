        ...
        <Card className="p-8 md:p-12 border-line shadow-soft bg-[#0B2A22]/72 backdrop-blur-[24px] relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-zinc-200 leading-relaxed text-base font-medium">
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">1. Data We Collect</h4>
              <p>
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">2. Payment Security</h4>
              <p>
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">3. Data Sharing & Consent</h4>
              <p>
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">4. Your Rights</h4>
              <p>
