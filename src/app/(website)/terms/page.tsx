...
export default async function TermsPage() {
  ...
  return (
    <Section background="default" className="bg-base relative overflow-hidden py-16 md:py-24 text-left">
        ...
        <Card className="p-8 md:p-12 border-line shadow-soft bg-[#0B2A22]/72 backdrop-blur-[24px] relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-zinc-200 leading-relaxed text-base font-medium">
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">1. Use of Content & Gated Materials</h4>
              <p>
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">2. Account Credentials & Security</h4>
              <p>
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">3. Payments, GST, & Refunds</h4>
              <p>
              ...
              <h4 className="text-lg font-bold text-white font-display pt-4">4. Governing Law</h4>
              <p>
