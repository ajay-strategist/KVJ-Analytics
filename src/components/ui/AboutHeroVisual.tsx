...
export function AboutHeroVisual() {
  return (
    <div className="relative w-full aspect-square max-w-[420px] mx-auto flex items-center justify-center animate-[float-slow_7s_ease-in-out_infinite]">
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-[#43F5FF]/8 via-[#3A7BFF]/5 to-[#43F5FF]/12 rounded-full blur-[80px] pointer-events-none" />
      <div className="absolute bottom-[-15px] w-[80%] h-8 bg-[#43F5FF]/20 rounded-full blur-[10px] transform scale-y-[0.3] pointer-events-none" />
      ...
      <div className="absolute top-2 -left-6 z-20 animate-[float-slow_6s_ease-in-out_infinite] group">
        <div className="bg-[#0E1117]/85 backdrop-blur-md border border-[#43F5FF]/25 hover:border-[#43F5FF] px-3 py-2 rounded-xl flex items-center gap-2 shadow-[0_0_15px_rgba(67,245,255,0.12)] transition-all duration-300">
          <div className="p-1 rounded-lg bg-[#43F5FF]/10 text-[#43F5FF]">
      ...
      <div className="absolute top-[18%] -right-6 z-20 animate-[float-slow_5s_ease-in-out_infinite_1s] group">
        <div className="bg-[#0E1117]/85 backdrop-blur-md border border-[#3A7BFF]/25 hover:border-[#3A7BFF] px-3 py-2 rounded-xl flex items-center gap-2 shadow-[0_0_15px_rgba(58,123,255,0.12)] transition-all duration-300">
          <div className="p-1 rounded-lg bg-[#3A7BFF]/10 text-[#3A7BFF]">
      ...
      <svg viewBox="0 0 400 400" className="w-full h-full relative z-10 overflow-visible">
        ...
        <circle cx="200" cy="200" r="165" fill="none" stroke="rgba(67, 245, 255, 0.06)" strokeWidth="1" strokeDasharray="5, 8" />
        <circle cx="200" cy="200" r="150" fill="none" stroke="rgba(58, 123, 255, 0.04)" strokeWidth="2" strokeDasharray="40, 30" className="animate-[spin_45s_linear_infinite]" style={{ transformOrigin: "200px 200px" }} />
        <circle cx="200" cy="200" r="135" fill="none" stroke="rgba(67, 245, 255, 0.05)" strokeWidth="1.5" strokeDasharray="10, 15" className="animate-[spin_25s_linear_infinite_reverse]" style={{ transformOrigin: "200px 200px" }} />
        ...
        <g fill="none" strokeWidth="1.5" strokeLinecap="round">
          <path id="path-visual-usa" d="M 200 200 Q 130 160 90 140" stroke="rgba(67, 245, 255, 0.12)" />
          <path id="path-visual-europe" d="M 200 200 Q 160 140 140 100" stroke="rgba(58, 123, 255, 0.12)" />
          <path id="path-visual-uae" d="M 200 200 Q 250 170 290 150" stroke="rgba(67, 245, 255, 0.12)" />
          <path id="path-visual-oman" d="M 200 200 Q 260 210 310 220" stroke="rgba(58, 123, 255, 0.12)" />
          <path id="path-visual-india" d="M 200 200 Q 170 215 150 230" stroke="rgba(67, 245, 255, 0.12)" />
        </g>

        {/* Flowing Data Particles */}
        <circle r="3" fill="#43F5FF" filter="url(#cyberGlowVisual)">
          <animateMotion dur="3s" repeatCount="indefinite">
            <mpath href="#path-visual-usa" />
          </animateMotion>
        </circle>
        <circle r="3.2" fill="#3A7BFF" filter="url(#cyberGlowVisual)">
        ...
        <circle r="2.8" fill="#3A7BFF" filter="url(#cyberGlowVisual)">
        ...
        {/* USA */}
        <g>
          <circle cx="90" cy="140" r="8" fill="rgba(67, 245, 255, 0.1)" />
          <circle cx="90" cy="140" r="4.5" fill="#43F5FF" className="animate-pulse" />
          <text x="90" y="124" fill="#FFFFFF" fontSize="10" fontWeight="bold" letterSpacing="0.05em" textAnchor="middle" opacity="0.85">USA</text>
        </g>
        {/* Europe */}
        <g>
          <circle cx="140" cy="100" r="8" fill="rgba(58, 123, 255, 0.1)" />
          <circle cx="140" cy="100" r="4" fill="#3A7BFF" />
          <text x="140" y="84" fill="#FFFFFF" fontSize="10" fontWeight="bold" letterSpacing="0.05em" textAnchor="middle" opacity="0.85">EUROPE</text>
        </g>
        {/* UAE */}
        <g>
          <circle cx="290" cy="150" r="8" fill="rgba(67, 245, 255, 0.1)" />
          <circle cx="290" cy="150" r="4.5" fill="#43F5FF" className="animate-pulse" />
          <text x="290" y="134" fill="#FFFFFF" fontSize="10" fontWeight="bold" letterSpacing="0.05em" textAnchor="middle" opacity="0.85">UAE</text>
        </g>
        {/* Oman */}
        <g>
          <circle cx="310" cy="220" r="8" fill="rgba(58, 123, 255, 0.1)" />
          <circle cx="310" cy="220" r="4" fill="#3A7BFF" />
          <text x="310" y="204" fill="#FFFFFF" fontSize="10" fontWeight="bold" letterSpacing="0.05em" textAnchor="middle" opacity="0.85">OMAN</text>
        </g>
        {/* India */}
        <g>
          <circle cx="150" cy="230" r="8" fill="rgba(67, 245, 255, 0.1)" />
          <circle cx="150" cy="230" r="4" fill="#43F5FF" />
        ...
        <g>
          <circle cx="200" cy="200" r="12" fill="rgba(67, 245, 255, 0.15)" className="animate-ping duration-3000" />
          <circle cx="200" cy="200" r="7" fill="#050608" stroke="#43F5FF" strokeWidth="2.5" />
          <circle cx="200" cy="200" r="2.5" fill="#43F5FF" />
          <text x="216" y="204" fill="#43F5FF" fontSize="10" fontWeight="bold" letterSpacing="0.1em" textAnchor="start">KERALA</text>
        </g>
      </svg>
    </div>
  );
