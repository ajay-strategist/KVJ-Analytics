    ...
    <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center overflow-visible pointer-events-none select-none">
      <style jsx>{`
        ...
        @keyframes pulseGlowEdu {
          0%, 100% { filter: drop-shadow(0 0 10px rgba(58, 123, 255, 0.45)) drop-shadow(0 0 2px rgba(67, 245, 255, 0.2)); }
          50% { filter: drop-shadow(0 0 22px rgba(58, 123, 255, 0.8)) drop-shadow(0 0 5px rgba(67, 245, 255, 0.45)); }
        }
      `}</style>
      ...
      >
        ...
        >
          ...
          <path d="M 120 220 Q 250 280, 380 220" fill="none" stroke="rgba(67, 245, 255, 0.2)" strokeWidth="1.5" />
          <path d="M 150 240 Q 250 180, 350 240" fill="none" stroke="rgba(58, 123, 255, 0.2)" strokeWidth="1.5" />
          <path d="M 250 90 L 150 240 M 250 90 L 350 240 M 250 90 L 250 270" fill="none" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="1.2" />
          ...
          <g className="origin-center animate-[spin_30s_linear_infinite]" style={{ transformOrigin: "250px 140px" }}>
            <polygon
              ...
              fill="rgba(15, 18, 28, 0.65)"
              stroke="#43F5FF"
              strokeWidth="2.5"
              filter="url(#eduGlow)"
            />
            <line x1="250" y1="90" x2="250" y2="190" stroke="rgba(67,245,255,0.3)" strokeWidth="1" />
            <line x1="120" y1="140" x2="380" y2="140" stroke="rgba(67,245,255,0.3)" strokeWidth="1" />
