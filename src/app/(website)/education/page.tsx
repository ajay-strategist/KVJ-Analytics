    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#FAFAFC] text-[#0F172A]">
        ...
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden opacity-30">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="origin-center animate-[spin_90s_linear_infinite]" style={{ transformOrigin: "50% 50%" }}>
              <line x1="15%" y1="20%" x2="35%" y2="40%" stroke="rgba(6, 182, 212, 0.15)" strokeWidth="1" strokeDasharray="5 5" />
              <line x1="35%" y1="40%" x2="55%" y2="15%" stroke="rgba(139, 92, 246, 0.15)" strokeWidth="1" />
              <line x1="55%" y1="15%" x2="75%" y2="35%" stroke="rgba(6, 182, 212, 0.2)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="75%" y1="35%" x2="92%" y2="20%" stroke="rgba(139, 92, 246, 0.15)" strokeWidth="1.2" />
              <line x1="35%" y1="40%" x2="65%" y2="65%" stroke="rgba(6, 182, 212, 0.1)" strokeWidth="1" />
              <line x1="65%" y1="65%" x2="85%" y2="50%" stroke="rgba(139, 92, 246, 0.15)" strokeWidth="1" />
              
              <circle cx="15%" cy="20%" r="3" fill="#06B6D4" className="animate-pulse" />
              <circle cx="35%" cy="40%" r="4" fill="#8B5CF6" />
              <circle cx="55%" cy="15%" r="3.5" fill="#06B6D4" />
              <circle cx="75%" cy="35%" r="4" fill="#8B5CF6" className="animate-pulse" />
              <circle cx="92%" cy="20%" r="3" fill="#06B6D4" />
        ...
        <Container className="relative z-10 py-24 md:py-32 text-center">
          <Reveal>
            <p className="text-[13px] uppercase tracking-[0.2em] text-[#8B5CF6] mb-5 font-bold">
          ...
          />
          <Reveal delay={150}>
            <p className="text-xl md:text-2xl text-[#0096C7] font-medium mb-6">{page.strapline}</p>
      ...
      <Section className="relative bg-white overflow-hidden z-10 border-t border-slate-100">
        ...
        <Container className="relative z-10">
          ...
          <Reveal className="mt-20 md:mt-24 max-w-3xl mx-auto">
            <div className="relative overflow-hidden p-10 md:p-12 text-center rounded-[32px] bg-white/70 border border-[#8B5CF6]/10 backdrop-blur-[32px] shadow-[0_20px_50px_rgba(11,31,58,0.03)]">
              {/* Breathing background glow (cyan to deep blue) */}
              <div 
                className="absolute -inset-10 bg-gradient-to-r from-[#00F0FF]/5 via-[#8B5CF6]/5 to-indigo-500/10 rounded-[40px] blur-[80px] pointer-events-none"
                style={{
              ...
              <div className="relative z-10 inline-block overflow-visible mt-2">
                {/* Ripple rings */}
                <span className="absolute -inset-2 rounded-full border border-[#00F0FF]/25 animate-[ripple_3s_ease-out_infinite] pointer-events-none z-0" />
                <span className="absolute -inset-4 rounded-full border border-[#8B5CF6]/15 animate-[ripple_3s_ease-out_infinite_1.5s] pointer-events-none z-0" />
                
                <Button 
                  href="/contact" 
                  variant="education" 
                  className="relative z-10 shadow-[0_0_20px_rgba(6,182,212,0.15)] hover:shadow-[0_0_35px_rgba(6,182,212,0.35)]"
                >
