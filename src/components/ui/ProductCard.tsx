...
function GradeScopeHologram() {
  return (
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-slate-50/70 rounded-2xl border border-slate-200/60 overflow-hidden group-hover:border-[#00F0FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        ...
        <g transform="translate(100, 75) rotate(-20) skewX(25) scale(0.9)">
          {/* Base plate */}
          <polygon points="-60,-40 60,-40 60,40 -60,40" fill="none" stroke="rgba(6, 182, 212, 0.25)" strokeWidth="1.5" />
          <polygon points="-50,-30 50,-30 50,30 -50,30" fill="none" stroke="rgba(29, 78, 216, 0.15)" strokeWidth="1" strokeDasharray="3, 2" />
          
          {/* Grid lines */}
          <line x1="-60" y1="-20" x2="60" y2="-20" stroke="rgba(6, 182, 212, 0.08)" strokeWidth="1" />
          <line x1="-60" y1="0" x2="60" y2="0" stroke="rgba(6, 182, 212, 0.08)" strokeWidth="1" />
          <line x1="-60" y1="20" x2="60" y2="20" stroke="rgba(6, 182, 212, 0.08)" strokeWidth="1" />
          <line x1="-40" y1="-40" x2="-40" y2="40" stroke="rgba(6, 182, 212, 0.08)" strokeWidth="1" />
          <line x1="0" y1="-40" x2="0" y2="40" stroke="rgba(6, 182, 212, 0.08)" strokeWidth="1" />
          <line x1="40" y1="-40" x2="40" y2="40" stroke="rgba(6, 182, 212, 0.08)" strokeWidth="1" />

          {/* Dynamic rising bar charts */}
          {/* Bar 1 (Cyan) */}
          <g className="animate-[bar-grow_3.5s_ease-in-out_infinite_0.2s]" style={{ transformOrigin: "-25px 0px" }}>
            <polygon points="-30,0 -20,0 -20,-25 -30,-25" fill="#00B4D8" opacity="0.8" />
            <polygon points="-30,-25 -20,-25 -15,-28 -25,-28" fill="#80FAFF" />
            <polygon points="-20,0 -15,-3 -15,-28 -20,-25" fill="#0096C7" />
          </g>
          ...
          <g className="animate-[bar-grow_3.5s_ease-in-out_infinite_1.4s]" style={{ transformOrigin: "15px 0px" }}>
            <polygon points="10,0 20,0 20,-30 10,-30" fill="#2563EB" opacity="0.8" />
            <polygon points="10,-30 20,-30 25,-33 15,-33" fill="#66A0FF" />
            <polygon points="20,0 25,-3 25,-33 20,-30" fill="#1D4ED8" />
          </g>

          {/* Bar 4 (Cyan) */}
          <g className="animate-[bar-grow_3.5s_ease-in-out_infinite_2s]" style={{ transformOrigin: "35px 0px" }}>
            <polygon points="30,0 40,0 40,-50 30,-50" fill="#00B4D8" opacity="0.85" />
            <polygon points="30,-50 40,-50 45,-53 35,-53" fill="#80FAFF" />
            <polygon points="40,0 45,-3 45,-53 40,-50" fill="#0096C7" />
          </g>
          ...
          <circle cx="-15" cy="-25" r="2" fill="#00B4D8" />
          <circle cx="45" cy="-42" r="2" fill="#0B1F3A" />
        </g>

        {/* Projection laser streams */}
        <line x1="40" y1="110" x2="100" y2="75" stroke="rgba(6, 182, 212, 0.15)" strokeWidth="0.8" strokeDasharray="3, 3" />
        <line x1="160" y1="110" x2="100" y2="75" stroke="rgba(6, 182, 212, 0.15)" strokeWidth="0.8" strokeDasharray="3, 3" />
        
        {/* Floating status badge */}
        <g className="animate-[float-slow_5s_ease-in-out_infinite]">
          <rect x="25" y="15" width="150" height="20" rx="6" fill="rgba(255, 255, 255, 0.9)" stroke="rgba(6, 182, 212, 0.3)" strokeWidth="1.2" />
          <circle cx="36" cy="25" r="3" fill="#00B4D8" className="animate-pulse" />
          <text x="48" y="28" fill="#0B1F3A" fontSize="8" fontFamily="monospace" letterSpacing="0.1em">GRADESCOPE // ONLINE</text>
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-slate-50/70 rounded-2xl border border-slate-200/60 overflow-hidden group-hover:border-[#00F0FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        ...
        <g transform="translate(100, 80) rotate(-20) skewX(25) scale(0.95)">
          {/* Microchip Body */}
          <polygon points="-40,-40 40,-40 40,40 -40,40" fill="white" stroke="rgba(29, 78, 216, 0.25)" strokeWidth="2" />
          <polygon points="-32,-32 32,-32 32,32 -32,32" fill="none" stroke="#D4AF37" strokeWidth="1.2" />
          
          {/* Core Processor inside */}
          <polygon points="-16,-16 16,-16 16,16 -16,16" fill="rgba(6, 182, 212, 0.15)" stroke="#06B6D4" strokeWidth="1.5" className="animate-pulse" />
          
          {/* Microchip Pins/Connectors */}
          {/* Left Pins */}
          <line x1="-40" y1="-25" x2="-48" y2="-25" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="-40" y1="-10" x2="-48" y2="-10" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="-40" y1="5" x2="-48" y2="5" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="-40" y1="20" x2="-48" y2="20" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          {/* Right Pins */}
          <line x1="40" y1="-25" x2="48" y2="-25" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="40" y1="-10" x2="48" y2="-10" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="40" y1="5" x2="48" y2="5" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="40" y1="20" x2="48" y2="20" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          {/* Top Pins */}
          <line x1="-25" y1="-40" x2="-25" y2="-48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="-10" y1="-40" x2="-10" y2="-48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="5" y1="-40" x2="5" y2="-48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="20" y1="-40" x2="20" y2="-48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          {/* Bottom Pins */}
          <line x1="-25" y1="40" x2="-25" y2="48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="-10" y1="40" x2="-10" y2="48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
          <line x1="5" y1="40" x2="5" y2="48" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
        ...
        <g transform="translate(100, 50)" className="animate-[float-slow_6s_ease-in-out_infinite]">
          ...
          <g className="animate-[spin_10s_linear_infinite]" style={{ transformOrigin: "0px 0px" }}>
            <line x1="0" y1="0" x2="-35" y2="-20" stroke="#2563EB" strokeWidth="1.2" strokeDasharray="3, 2" />
            <line x1="0" y1="0" x2="35" y2="-15" stroke="#06B6D4" strokeWidth="1.2" strokeDasharray="3, 2" />
            <line x1="0" y1="0" x2="10" y2="35" stroke="#D4AF37" strokeWidth="1.2" strokeDasharray="3, 2" />

            {/* Orbit Synapse Nodes */}
            <circle cx="-35" cy="-20" r="5.5" fill="white" stroke="#2563EB" strokeWidth="2" />
            <circle cx="-35" cy="-20" r="2.5" fill="#2563EB" className="animate-pulse" />
            
            <circle cx="35" cy="-15" r="5.5" fill="white" stroke="#06B6D4" strokeWidth="2" />
            <circle cx="35" cy="-15" r="2.5" fill="#06B6D4" className="animate-pulse" />
            
            <circle cx="10" cy="35" r="5" fill="white" stroke="#D4AF37" strokeWidth="1.8" />
            <circle cx="10" cy="35" r="2" fill="#D4AF37" />
          </g>

          {/* Central main core node */}
          <circle cx="0" cy="0" r="8" fill="white" stroke="#06B6D4" strokeWidth="2.5" />
          <circle cx="0" cy="0" r="3.5" fill="#06B6D4" className="animate-ping" />
          <circle cx="0" cy="0" r="3" fill="#06B6D4" />
        </g>

        {/* Faint rising code/data packets */}
        <g fontSize="6" fontFamily="monospace" fill="#06B6D4" opacity="0.6">
    ...
    >
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .btn-liquid-glow-sweep::before {
          ...
          background: conic-gradient(from 0deg, transparent 40%, #D4AF37 50%, transparent 60%);
        ...
        .btn-liquid-glow-sweep:hover {
          ...
          box-shadow: 0 0 25px rgba(212, 175, 55, 0.4), 0 0 10px rgba(11, 31, 58, 0.2) !important;
        }
      ...
      >
        <div
          className="relative h-full flex flex-col overflow-hidden p-8 md:p-9 rounded-[32px] bg-white/85 backdrop-blur-[32px] border border-[#0B1F3A]/10 transition-all duration-500 shadow-[0_4px_24px_rgba(11,31,58,0.03)]"
          style={{
            borderColor: isHovered
              ? isGradeScope ? "rgba(6, 182, 212, 0.4)" : "rgba(29, 78, 216, 0.4)"
              : "rgba(11, 31, 58, 0.08)",
            boxShadow: isHovered
              ? "0 18px 48px rgba(11, 31, 58, 0.05)"
              : "none",
          }}
        >
          {/* Top accent line */}
          ...
          {isHovered && (
            <div
              ...
              style={{
                background: `radial-gradient(350px circle at ${mousePos.x}px ${mousePos.y}px, rgba(11, 31, 58, 0.03), transparent 80%)`,
              }}
            />
          )}
          ...
          >
            ...
            <div>
              <h3 
                ...
                style={{
                  color: isHovered ? (isGradeScope ? "#06B6D4" : "#2563EB") : "#0B1F3A",
                }}
              >
                {name}
              </h3>
          ...
          <div style={{ transform: isHovered ? "translateZ(15px)" : "translateZ(0)", transition: "transform 0.3s ease" }} className="flex-grow flex flex-col">
            <p className="relative text-sm font-semibold text-[#0B1F3A] mb-4 italic">{tagline}</p>
            <p className="relative text-[15px] text-[#475569] font-light leading-relaxed mb-7">{description}</p>

            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-8">
              {keyFeatures.map((feat: string, fIdx: number) => (
                <div key={fIdx} className="flex items-start gap-2.5 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-50 px-3.5 py-3 transition-colors duration-250">
                  <Check className={`mt-0.5 h-4 w-4 shrink-0 ${isGradeScope ? "text-brand" : "text-corporate"}`} />
                  <span className="text-[12.5px] font-medium text-[#0F172A] leading-snug">{feat}</span>
                </div>
              ))}
            </div>
          </div>
