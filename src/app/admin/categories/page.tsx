    ...
    <div className="min-h-screen bg-surface p-8 text-ink">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            <h2 className="text-lg font-bold text-slate-900">Course Categories</h2>
            <p className="text-sm text-slate-500">Manage training platform tracks and course categories.</p>
          </div>
        </div>
