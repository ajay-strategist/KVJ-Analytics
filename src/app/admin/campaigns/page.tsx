...
export default function AdminCampaignsPage() {
  ...
  const getAutoGeneratedIdPreview = () => {
    ...
    return `CMP-${prefix}-${year}-001 (Auto-generated)`;
  };
              ...
              <>
                ...
                <div className="bg-card border border-line rounded-3xl p-6 shadow-soft space-y-4">
                  ...
                  {previewTab === "editor" ? (
                    ...
                    /* DYNAMIC HEIGHT FORM PREVIEW (NO NESTED SCROLLBAR!) */
            ...
            <div className="bg-white border border-line rounded-3xl max-w-2xl w-full p-6 space-y-6 shadow-2xl max-h-[90vh] overflow-y-auto">
              ...
              {createStep === 2 && (
                <div className="space-y-5">
                  ...
                  {formChoice === "existing" ? (
                    <div className="space-y-3">
                      <label className="block text-xs font-bold text-ink">Select Existing Form</label>
                      {savedForms.length > 0 ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        rows={8}
                        className="w-full px-3 py-2 border border-line rounded-xl text-xs font-mono bg-slate-950 text-green-300 resize-y focus:outline-none focus:ring-2 focus:ring-brand/20"
                      />
                    </div>
                  )}
                  ...
                  <div className="pt-4 border-t border-line flex items-center justify-between">
                    <button
                      ...
                      className="text-xs font-bold text-slate hover:text-ink"
                    >
                      ← Back to Details
                    </button>
                    ...
                    <Button
                      ...
                      className="py-2.5 px-6 bg-brand text-white hover:bg-brand/90 text-xs font-bold flex items-center gap-2 cursor-pointer shadow-md"
                    >
                      {savingCampaign ? (
