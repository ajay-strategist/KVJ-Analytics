...
function EduTrainingIcon() {
  return (
    <svg viewBox="0 0 100 100" className="w-12 h-12">
      ...
      <rect x="56" y="20" width="38" height="32" rx="3" fill="rgba(15,18,28,0.72)" stroke="#43F5FF" strokeWidth="1.8" />
      <g transform="translate(62, 50)">
        <rect x="0" y="-20" width="5" height="20" rx="1" fill="#3A7BFF" className="animate-[pulse_1.5s_infinite]" />
        <rect x="9" y="-28" width="5" height="28" rx="1" fill="#43F5FF" className="animate-[pulse_1.8s_infinite_0.3s]" />
        <rect x="18" y="-12" width="5" height="12" rx="1" fill="#3A7BFF" className="animate-[pulse_1.3s_infinite_0.6s]" />
        <rect x="27" y="-22" width="5" height="22" rx="1" fill="#43F5FF" className="animate-[pulse_1.5s_infinite_0.9s]" />
      </g>
      <line x1="56" y1="52" x2="94" y2="52" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
      {/* Stand */}
      ...
      {[20, 40, 60, 80].map((x, i) => (
        <circle key={i} cx={x} cy="80" r="5" fill="rgba(58,123,255,0.3)" stroke="#3A7BFF" strokeWidth="1.5"
          className="animate-[pulse_2s_ease-in-out_infinite]"
    ...
    <svg viewBox="0 0 100 100" className="w-12 h-12">
      <defs>
        <linearGradient id="cyanBlueGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" stopColor="#16E6D8" />
      ...
      {/* Text lines */}
      <line x1="30" y1="36" x2="70" y2="36" stroke="rgba(67,245,255,0.5)" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="34" y1="44" x2="66" y2="44" stroke="rgba(67,245,255,0.35)" strokeWidth="1" strokeLinecap="round" />
      {/* Star seal */}
...
function EduCurriculumIcon() {
  return (
    <svg viewBox="0 0 100 100" className="w-12 h-12">
      {/* Root node */}
      <circle cx="50" cy="20" r="8" fill="rgba(15,18,28,0.72)" stroke="#3A7BFF" strokeWidth="2.2"
        className="animate-[pulse_2s_ease-in-out_infinite]" />
      <circle cx="50" cy="20" r="4" fill="#3A7BFF" />
      {/* Trunk */}
      <line x1="50" y1="28" x2="50" y2="45" stroke="#3A7BFF" strokeWidth="2" />
      {/* Left branch */}
      <line x1="50" y1="45" x2="28" y2="58" stroke="#3A7BFF" strokeWidth="1.8" />
      <circle cx="28" cy="62" r="7" fill="rgba(15,18,28,0.72)" stroke="#43F5FF" strokeWidth="2"
        className="animate-[pulse_2s_ease-in-out_infinite_0.4s]" />
      <circle cx="28" cy="62" r="3.5" fill="#43F5FF" />
      {/* Left sub-branches */}
      <line x1="28" y1="69" x2="18" y2="80" stroke="rgba(67,245,255,0.5)" strokeWidth="1.5" />
      <circle cx="18" cy="84" r="5" fill="rgba(15,18,28,0.72)" stroke="rgba(67,245,255,0.6)" strokeWidth="1.5"
        className="animate-[pulse_2s_ease-in-out_infinite_0.6s]" />
      <line x1="28" y1="69" x2="36" y2="80" stroke="rgba(67,245,255,0.5)" strokeWidth="1.5" />
      <circle cx="36" cy="84" r="5" fill="rgba(15,18,28,0.72)" stroke="rgba(67,245,255,0.6)" strokeWidth="1.5"
        className="animate-[pulse_2s_ease-in-out_infinite_0.8s]" />
      {/* Right branch */}
      <line x1="50" y1="45" x2="72" y2="58" stroke="#3A7BFF" strokeWidth="1.8" />
      <circle cx="72" cy="62" r="7" fill="rgba(15,18,28,0.72)" stroke="#43F5FF" strokeWidth="2"
        className="animate-[pulse_2s_ease-in-out_infinite_0.6s]" />
      <circle cx="72" cy="62" r="3.5" fill="#43F5FF" />
      {/* Right sub-branches */}
      <line x1="72" y1="69" x2="62" y2="80" stroke="rgba(67,245,255,0.5)" strokeWidth="1.5" />
      <circle cx="62" cy="84" r="5" fill="rgba(15,18,28,0.72)" stroke="rgba(67,245,255,0.6)" strokeWidth="1.5"
        className="animate-[pulse_2s_ease-in-out_infinite_1s]" />
      <line x1="72" y1="69" x2="82" y2="80" stroke="rgba(67,245,255,0.5)" strokeWidth="1.5" />
      <circle cx="82" cy="84" r="5" fill="rgba(15,18,28,0.72)" stroke="rgba(67,245,255,0.6)" strokeWidth="1.5"
...
function EduAnalyticsIcon() {
  return (
    <svg viewBox="0 0 100 100" className="w-12 h-12">
      {/* Dashboard frame */}
      <rect x="10" y="16" width="80" height="68" rx="6" fill="rgba(15,18,28,0.72)" stroke="#3A7BFF" strokeWidth="2" />
      <rect x="10" y="16" width="80" height="14" rx="4" fill="rgba(58,123,255,0.15)" />
      {/* Header dots */}
      <circle cx="22" cy="23" r="2.5" fill="#43F5FF" opacity="0.7" />
      <circle cx="30" cy="23" r="2.5" fill="#3A7BFF" opacity="0.5" />
      {/* Grade ring */}
      <g transform="translate(34, 57)">
        <circle cx="0" cy="0" r="16" fill="none" stroke="rgba(255,255,255,0.06)" strokeWidth="5" />
        <circle cx="0" cy="0" r="16" fill="none" stroke="#43F5FF" strokeWidth="5"
          strokeDasharray="100" strokeDashoffset="28" strokeLinecap="round"
          transform="rotate(-90)" className="animate-[pulse_2.5s_ease-in-out_infinite]" />
        <text x="-6" y="4" fill="#43F5FF" fontSize="7" fontWeight="bold">A+</text>
      </g>
      {/* Attendance bars right side */}
      <g transform="translate(60, 80)">
        <rect x="0" y="-36" width="6" height="36" rx="1" fill="rgba(58,123,255,0.7)" className="animate-[pulse_1.8s_infinite]" />
        <rect x="10" y="-48" width="6" height="48" rx="1" fill="rgba(67,245,255,0.8)" className="animate-[pulse_2s_infinite_0.3s]" />
        <rect x="20" y="-24" width="6" height="24" rx="1" fill="rgba(58,123,255,0.7)" className="animate-[pulse_1.6s_infinite_0.6s]" />
      </g>
      <line x1="58" y1="81" x2="90" y2="81" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
    </svg>
  );
}
...
function EduAssessmentIcon() {
  return (
    <svg viewBox="0 0 100 100" className="w-12 h-12">
      {/* Clipboard */}
      <rect x="20" y="20" width="60" height="70" rx="5" fill="rgba(15,18,28,0.72)" stroke="#3A7BFF" strokeWidth="2" />
      {/* Clipboard top clip */}
      <rect x="36" y="14" width="28" height="14" rx="4" fill="rgba(15,18,28,0.85)" stroke="#3A7BFF" strokeWidth="2" />
      <rect x="42" y="17" width="16" height="8" rx="2" fill="rgba(58,123,255,0.25)" />
      {/* Question lines */}
      <line x1="32" y1="42" x2="68" y2="42" stroke="rgba(58,123,255,0.4)" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="32" y1="54" x2="68" y2="54" stroke="rgba(58,123,255,0.4)" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="32" y1="66" x2="60" y2="66" stroke="rgba(58,123,255,0.4)" strokeWidth="1.5" strokeLinecap="round" />
      ...
      <g transform="translate(72, 76)" className="origin-center animate-[spin_3s_linear_infinite]">
        <circle cx="0" cy="0" r="8" fill="none" stroke="rgba(67,245,255,0.15)" strokeWidth="2.5" />
        <circle cx="0" cy="0" r="8" fill="none" stroke="#43F5FF" strokeWidth="2.5"
      ...
      >
        <div
          ...
          style={{
            boxShadow: isHovered
              ? accentColor === "cyan"
                ? "0 15px 40px rgba(67, 245, 255, 0.16)"
                : "0 15px 40px rgba(58, 123, 255, 0.16)"
              : "none",
          }}
        >
          ...
          <div
            ...
            style={{
              ...
              background: accentColor === "cyan"
                ? `radial-gradient(150px circle at ${mousePos.x}px ${mousePos.y}px, rgba(67, 245, 255, 0.8), transparent 75%)`
                : `radial-gradient(150px circle at ${mousePos.x}px ${mousePos.y}px, rgba(58, 123, 255, 0.8), transparent 75%)`,
              padding: "1.5px",
          ...
          <div
            ...
            style={{
              ...
              borderColor: isHovered 
                ? accentColor === "cyan" ? "rgba(67, 245, 255, 0.45)" : "rgba(58, 123, 255, 0.45)"
          ...
          >
            ...
            <h3
              ...
              style={{
                color: isHovered 
                  ? accentColor === "cyan" ? "#43F5FF" : "#3A7BFF"
                  : "#FFFFFF",
              }}
            >
              {title}
