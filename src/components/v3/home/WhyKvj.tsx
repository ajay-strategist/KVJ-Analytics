          ...
          <div ref={gridRef} className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {cards.map((c, i) => {
              ...
              return (
                <div
                  key={i}
                  className="why-block group light-sweep glow-ring relative h-full rounded-2xl border border-line bg-base-2/40 p-6 transition-all duration-500 hover:-translate-y-1.5 hover:border-brand/40 hover:bg-white hover:shadow-[0_10px_30px_rgba(15,23,42,0.04)]"
