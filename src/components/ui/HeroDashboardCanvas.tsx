...
export function HeroDashboardCanvas() {
  ...
  return (
    <div className="relative w-full max-w-[550px] mx-auto aspect-[4/3] flex items-center justify-center select-none py-4">
      ...
      <div className="absolute inset-0 bg-brand/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute inset-0 bg-corporate/5 rounded-full blur-[90px] pointer-events-none" />
      ...
      >
        ...
        >
          ...
          <div 
            className="absolute left-1 top-8 w-[270px] h-[240px] rounded-2xl bg-glass-card border border-line shadow-soft backdrop-blur-xl transition-all duration-300"
            style={{
          ...
          >
            ...
            <div className="relative w-full h-[180px] px-3 pt-2">
              ...
              <div className="absolute left-2 top-2 bottom-6 w-full flex flex-col justify-between text-[7px] font-mono text-slate">
                {["100", "80", "60", "40", "20", "0"].map((label, idx) => (
                  <div key={idx} className="flex items-center w-full gap-2">
                    ...
                    <div className="w-[215px] h-[1px] bg-white/5" />
                  </div>
                ))}
              </div>
              ...
              <div className="absolute left-9 bottom-1.5 right-4 flex justify-between text-[8px] font-mono text-slate">
                {["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug"].map((m, idx) => (
                  <span key={idx}>{m}</span>
                ))}
              </div>

              {/* Neon pulse Alert Node at Peak Point */}
              <div 
          ...
          >
            ...
            >
              ...
              <div 
                className="absolute inset-x-0 bottom-0 h-[130px] rounded-2xl bg-glass-card/50 border border-line backdrop-blur-md shadow-lg flex items-center justify-center"
                style={{ 
