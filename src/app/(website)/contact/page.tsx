...
export default async function ContactPage() {
  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-20 md:pb-28 bg-base text-zinc-200 min-h-screen text-left">
      {/* 3D Grid / Data streams overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(67,245,255,0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(67,245,255,0.02)_1px,transparent_1px)] bg-[size:4rem_4rem] pointer-events-none opacity-40" />
      <div className="blob animate-blob absolute -top-24 right-[-4rem] w-[28rem] h-[28rem] bg-[#43F5FF]/5 pointer-events-none blur-[100px]" />
      <div className="blob animate-blob absolute bottom-[-6rem] left-[-4rem] w-[24rem] h-[24rem] bg-[#3A7BFF]/4 pointer-events-none blur-[90px]" style={{ animationDelay: "4s" }} />
      ...
      <Container className="relative z-10">
        ...
        <Reveal className="max-w-6xl mx-auto rounded-[32px] overflow-hidden shadow-soft border border-line bg-[#0E1117]/72 backdrop-blur-[24px]">
          <div className="grid lg:grid-cols-12">
            
            {/* Info panel */}
            <div
              className="lg:col-span-5 relative overflow-hidden p-8 sm:p-10 text-white flex flex-col min-h-[500px] border-r border-line bg-gradient-to-br from-[#0A0D13] to-[#0E1117]"
            >
              {/* Glowing backlights */}
              <div className="absolute -top-20 -right-16 w-64 h-64 rounded-full blur-3xl pointer-events-none animate-blob" style={{ background: "rgba(67, 245, 255, 0.05)" }} />
              <div className="absolute -bottom-24 -left-12 w-64 h-64 rounded-full blur-3xl pointer-events-none animate-blob" style={{ background: "rgba(58, 123, 255, 0.03)", animationDelay: "3s" }} />
                ...
                <svg viewBox="0 0 400 400" className="w-full h-full overflow-visible">
                  <defs>
                    <radialGradient id="globeGlow" cx="50%" cy="50%" r="50%">
                      <stop offset="0%" stopColor="#43F5FF" stopOpacity="0.15" />
                  ...
                  <g className="animate-[spin_40s_linear_infinite]" style={{ transformOrigin: "200px 200px" }}>
                    <circle cx="200" cy="200" r="120" fill="none" stroke="rgba(67, 245, 255, 0.35)" strokeWidth="1.2" />
                    <ellipse cx="200" cy="200" rx="120" ry="40" fill="none" stroke="rgba(67, 245, 255, 0.25)" strokeWidth="1" />
                    <ellipse cx="200" cy="200" rx="120" ry="80" fill="none" stroke="rgba(67, 245, 255, 0.25)" strokeWidth="1" />
                    <ellipse cx="200" cy="200" rx="40" ry="120" fill="none" stroke="rgba(67, 245, 255, 0.25)" strokeWidth="1" />
                    <ellipse cx="200" cy="200" rx="80" ry="120" fill="none" stroke="rgba(67, 245, 255, 0.25)" strokeWidth="1" />
                    <line x1="200" y1="80" x2="200" y2="320" stroke="rgba(58, 123, 255, 0.2)" strokeWidth="1" />
                    <line x1="80" y1="200" x2="320" y2="200" stroke="rgba(58, 123, 255, 0.2)" strokeWidth="1" />
                  </g>

                  {/* India origin radar waves */}
                  <g transform="translate(210, 205)">
                    <circle cx="0" cy="0" r="12" fill="none" stroke="#43F5FF" strokeWidth="1.2" className="animate-ping duration-3000" />
                    <circle cx="0" cy="0" r="30" fill="none" stroke="rgba(67, 245, 255, 0.5)" strokeWidth="1" className="animate-[ping_3.5s_linear_infinite]" />
                    <circle cx="0" cy="0" r="60" fill="none" stroke="rgba(58, 123, 255, 0.3)" strokeWidth="1" className="animate-[ping_5s_linear_infinite]" />
                    
                    <circle cx="0" cy="0" r="4.5" fill="#050608" />
                    <circle cx="0" cy="0" r="2.5" fill="#43F5FF" className="animate-pulse" />
                  </g>

                  {/* Global projects paths */}
                  <path d="M 210 205 L 140 130 M 210 205 L 290 140 M 210 205 L 160 270 M 210 205 L 270 280" stroke="rgba(67, 245, 255, 0.35)" strokeWidth="1.2" strokeDasharray="3, 4" />
                  <circle cx="140" cy="130" r="3.5" fill="#43F5FF" className="animate-pulse" />
                  <circle cx="290" cy="140" r="3.5" fill="#43F5FF" className="animate-pulse" />
                  <circle cx="160" cy="270" r="3" fill="#3A7BFF" />
                  <circle cx="270" cy="280" r="3.5" fill="#3A7BFF" className="animate-pulse" />
                </svg>
              </div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="mb-10 text-left">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#43F5FF]">
                ...
                <ul className="space-y-6 mb-8 text-left">
                  <li className="flex items-start gap-4">
                    <span className="grid place-items-center h-11 w-11 rounded-2xl bg-[#43F5FF]/10 border border-[#43F5FF]/40 shrink-0 text-[#43F5FF] animate-pulse">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <a href={`mailto:${contact.email}`} className="text-sm font-semibold text-white hover:text-[#43F5FF] transition-colors break-all">
                        {contact.email}
                      </a>
                    </div>
                  </li>
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-0.5">
                        {contact.phones.map((phone: string, idx: number) => (
                          <a key={idx} href={`tel:${phone}`} className="text-sm font-semibold text-white hover:text-[#43F5FF] transition-colors">
                            {phone}
                          </a>
                        ))}
                      </div>
