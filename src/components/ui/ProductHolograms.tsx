...
export function GradeScopeHologram() {
  return (
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      <div className="absolute inset-0 bg-gradient-to-t from-[#43F5FF]/5 via-transparent to-transparent opacity-60 pointer-events-none" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4/5 h-1/2 bg-[#43F5FF]/5 rounded-full blur-xl pointer-events-none" />
...
export function ProtrixHologram() {
  return (
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      <div className="absolute inset-0 bg-gradient-to-t from-[#3A7BFF]/5 via-transparent to-transparent opacity-60 pointer-events-none" />
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 80) rotate(-20) skewX(25) scale(0.95)">
          ...
          <line x1="-40" y1="0" x2="-48" y2="0" stroke="rgba(67, 245, 255, 0.4)" strokeWidth="1.5" />
          <line x1="-40" y1="20" x2="-48" y2="20" stroke="rgba(67, 245, 255, 0.4)" strokeWidth="1.5" />
          <line x1="40" y1="-20" x2="48" y2="-20" stroke="rgba(67, 245, 255, 0.4)" strokeWidth="1.5" />
          <line x1="40" y1="0" x2="48" y2="0" stroke="rgba(67, 245, 255, 0.4)" strokeWidth="1.5" />
          <line x1="40" y1="20" x2="48" y2="20" stroke="rgba(67, 245, 255, 0.4)" strokeWidth="1.5" />
        ...
        <g transform="translate(100, 50)" className="animate-[float-slow_6s_ease-in-out_infinite]">
          <g className="animate-[spin_10s_linear_infinite]" style={{ transformOrigin: "0px 0px" }}>
            ...
            <circle cx="-35" cy="-20" r="5" fill="rgba(15, 18, 28, 0.85)" stroke="#3A7BFF" strokeWidth="2" />
            <circle cx="35" cy="-15" r="5" fill="rgba(15, 18, 28, 0.85)" stroke="#43F5FF" strokeWidth="2" />
          </g>
          <circle cx="0" cy="0" r="8" fill="rgba(15, 18, 28, 0.85)" stroke="#43F5FF" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)" className="animate-[float-slow_5s_ease-in-out_infinite]">
          <circle cx="0" cy="0" r="36" fill="none" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="1.2" />
          <ellipse rx="36" ry="12" fill="none" stroke="rgba(67, 245, 255, 0.25)" strokeWidth="1" className="animate-[spin_12s_linear_infinite]" style={{ transformOrigin: "0px 0px" }} />
          <ellipse rx="12" ry="36" fill="none" stroke="rgba(67, 245, 255, 0.2)" strokeWidth="1" className="animate-[spin_16s_linear_infinite]" style={{ transformOrigin: "0px 0px" }} />
          <circle cx="0" cy="0" r="20" fill="rgba(67, 245, 255, 0.05)" stroke="#43F5FF" strokeWidth="1.5" className="animate-pulse" />
          <g className="animate-[spin_8s_linear_infinite]" style={{ transformOrigin: "0px 0px" }}>
            <circle cx="48" cy="0" r="3" fill="#43F5FF" className="animate-ping" />
            <circle cx="48" cy="0" r="2" fill="#43F5FF" />
            <circle cx="-48" cy="0" r="2" fill="#3A7BFF" />
          </g>
        </g>
      </svg>
    </div>
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)" className="animate-[float-slow_4.5s_ease-in-out_infinite]">
          <ellipse rx="50" ry="15" fill="none" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="1" />
          <ellipse rx="35" ry="10" fill="none" stroke="rgba(67, 245, 255, 0.1)" strokeWidth="1" />
          <path d="M -15 -25 L 15 -25 C 15 -25 18 0 15 15 C 11 25 0 30 0 30 C 0 30 -11 25 -15 15 C -18 0 -15 -25 -15 -25 Z" 
            fill="rgba(58, 123, 255, 0.1)" stroke="#43F5FF" strokeWidth="2.2" className="animate-pulse" />
          <path d="M -6 0 L -2 4 L 6 -4" fill="none" stroke="#43F5FF" strokeWidth="2" strokeLinecap="round" />
          <circle cx="28" cy="-18" r="2.5" fill="#43F5FF" className="animate-pulse" />
          <circle cx="-25" cy="12" r="1.5" fill="#3A7BFF" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)">
          <path d="M -60 -20 H 60 M -60 20 H 60 M -60 0 H 60" fill="none" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="2" />
          <circle cx="-40" cy="-20" r="5" fill="#0A0D13" stroke="#43F5FF" strokeWidth="2" />
          <circle cx="0" cy="0" r="6" fill="#0A0D13" stroke="#3A7BFF" strokeWidth="2.5" />
          <circle cx="40" cy="20" r="5" fill="#0A0D13" stroke="#43F5FF" strokeWidth="2" />
          <circle cx="10" cy="-20" r="2.5" fill="#43F5FF" className="animate-[flow-x_3s_linear_infinite]" />
          <circle cx="-25" cy="0" r="2.5" fill="#3A7BFF" className="animate-[flow-x_4s_linear_infinite_1s]" />
          <circle cx="-10" cy="20" r="2.5" fill="#43F5FF" className="animate-[flow-x_2.5s_linear_infinite_0.5s]" />
        </g>
      </svg>
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)" className="animate-[float-slow_6s_ease-in-out_infinite]">
          <path d="M -25 -15 L -10 -25 L 10 -25 L 25 -15 L 20 10 L 0 20 L -20 10 Z" fill="none" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="1.2" />
          <line x1="-10" y1="-25" x2="0" y2="0" stroke="rgba(58, 123, 255, 0.3)" strokeWidth="1" />
          <line x1="10" y1="-25" x2="0" y2="0" stroke="rgba(58, 123, 255, 0.3)" strokeWidth="1" />
          <line x1="25" y1="-15" x2="0" y2="0" stroke="rgba(58, 123, 255, 0.3)" strokeWidth="1" />
          <line x1="-25" y1="-15" x2="0" y2="0" stroke="rgba(58, 123, 255, 0.3)" strokeWidth="1" />
          <line x1="0" y1="20" x2="0" y2="0" stroke="rgba(58, 123, 255, 0.3)" strokeWidth="1" />
          <circle cx="0" cy="0" r="5" fill="#43F5FF" className="animate-ping" />
          <circle cx="0" cy="0" r="4.5" fill="#FFFFFF" stroke="#43F5FF" strokeWidth="2.2" />
          <circle cx="-25" cy="-15" r="3" fill="#3A7BFF" />
          <circle cx="25" cy="-15" r="3" fill="#3A7BFF" />
          <circle cx="-10" cy="-25" r="3" fill="#43F5FF" />
          <circle cx="10" cy="-25" r="3" fill="#43F5FF" />
        </g>
      </svg>
    </div>
...
export function ExecutiveRadarHologram() {
  return (
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)">
          <circle cx="0" cy="0" r="40" fill="none" stroke="rgba(67, 245, 255, 0.15)" strokeWidth="1.2" />
          <circle cx="0" cy="0" r="25" fill="none" stroke="rgba(67, 245, 255, 0.1)" strokeWidth="1" />
          <line x1="-45" y1="0" x2="45" y2="0" stroke="rgba(67, 245, 255, 0.12)" strokeWidth="1" />
          <line x1="0" y1="-45" x2="0" y2="45" stroke="rgba(67, 245, 255, 0.12)" strokeWidth="1" />
          ...
          <circle cx="22" cy="-18" r="3" fill="#43F5FF" className="animate-ping" />
          <circle cx="22" cy="-18" r="2" fill="#43F5FF" />
          <circle cx="-20" cy="15" r="2" fill="#3A7BFF" />
        </g>
        <defs>
          <linearGradient id="radarSweep" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#43F5FF" stopOpacity="0.8" />
            <stop offset="100%" stopColor="#43F5FF" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
    </div>
...
export function FinancialDonutHologram() {
  return (
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)" className="animate-[float-slow_5s_ease-in-out_infinite]">
          <circle cx="0" cy="0" r="30" fill="none" stroke="rgba(58, 123, 255, 0.2)" strokeWidth="8" />
          <circle cx="0" cy="0" r="30" fill="none" stroke="#43F5FF" strokeWidth="8" strokeDasharray="120 188" strokeLinecap="round" />
          <circle cx="0" cy="0" r="22" fill="#0A0D13" stroke="rgba(67, 245, 255, 0.1)" strokeWidth="1" />
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 68)" className="animate-[float-slow_5.5s_ease-in-out_infinite]">
          ...
          <path d="M -40 0 A 40 40 0 0 1 20 -34.6" fill="none" stroke="#43F5FF" strokeWidth="6" strokeLinecap="round" />
          ...
          <circle cx="0" cy="0" r="5" fill="#0A0D13" stroke="#43F5FF" strokeWidth="2" />
        </g>
      </svg>
      <style dangerouslySetInnerHTML={{ __html: `
    ...
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 65)">
          ...
          <path d="M -60 15 Q -30 -15 0 0 T 60 -30 L 60 -10 T 0 15 Q -30 5 -60 15 Z" fill="rgba(67, 245, 255, 0.08)" />
          <path d="M -60 15 Q -30 -5 0 5" fill="none" stroke="#3A7BFF" strokeWidth="2.2" />
          <path d="M 0 5 Q 30 15 60 -20" fill="none" stroke="#43F5FF" strokeWidth="2.2" strokeDasharray="4, 3" />
          <circle cx="0" cy="5" r="4.5" fill="#43F5FF" className="animate-ping" />
          <circle cx="0" cy="5" r="3" fill="#FFFFFF" stroke="#43F5FF" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)" className="animate-[float-slow_6s_ease-in-out_infinite]">
          <g className="animate-[spin_20s_linear_infinite]" style={{ transformOrigin: "0px 0px" }}>
            <line x1="-30" y1="-25" x2="30" y2="-25" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
            <line x1="30" y1="-25" x2="40" y2="15" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
            <line x1="40" y1="15" x2="-10" y2="30" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
            <line x1="-10" y1="30" x2="-45" y2="5" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
            <line x1="-45" y1="5" x2="-30" y2="-25" stroke="rgba(67,245,255,0.2)" strokeWidth="1" />
            <circle cx="-30" cy="-25" r="5" fill="#0A0D13" stroke="#43F5FF" strokeWidth="1.8" />
            <circle cx="30" cy="-25" r="4" fill="#0A0D13" stroke="#3A7BFF" strokeWidth="1.5" />
            <circle cx="40" cy="15" r="5" fill="#0A0D13" stroke="#43F5FF" strokeWidth="1.8" />
          </g>
          <circle cx="0" cy="0" r="8" fill="#0A0D13" stroke="#43F5FF" strokeWidth="2.5" />
...
export function TimeSchedulerHologram() {
  return (
    <div className="relative w-full h-44 mb-6 flex items-center justify-center bg-white/5 rounded-2xl border border-line overflow-hidden group-hover:border-[#43F5FF]/40 transition-colors duration-500">
      ...
      <svg viewBox="0 0 200 120" className="w-full h-full overflow-visible relative z-10">
        <g transform="translate(100, 60)" className="animate-[float-slow_5s_ease-in-out_infinite]">
          <circle cx="0" cy="0" r="32" fill="none" stroke="rgba(67, 245, 255, 0.2)" strokeWidth="2" />
          <circle cx="0" cy="0" r="38" fill="none" stroke="rgba(58, 123, 255, 0.12)" strokeWidth="1.2" strokeDasharray="6, 6" />
          <g className="animate-[spin_12s_linear_infinite]" style={{ transformOrigin: "0px 0px" }}>
            <line x1="0" y1="0" x2="0" y2="-28" stroke="#43F5FF" strokeWidth="2.2" strokeLinecap="round" />
          </g>
