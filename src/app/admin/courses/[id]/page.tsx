...
export default function AdminCourseDetailsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"curriculum" | "mock-tests" | "reg-form">("curriculum");
            ...
            <div className="bg-white border border-line rounded-card p-6 shadow-soft space-y-6">
              ...
              {activeTab === "reg-form" && (
                <div className="space-y-5 pt-2">
                  <div className="flex items-center justify-between border-b border-line pb-3">
                    <div>
                      <h2 className="text-base font-bold font-display text-ink">Course Registration Form</h2>
                      <p className="text-[11px] text-slate mt-0.5">Paste the custom HTML form generated by ChatGPT / Gemini. It will be shown when students click "Register Interest" for this course.</p>
                    </div>
                    <a
                      href={`/training/register?course=${course.slug}`}
                      target="_blank"
                      rel="noreferrer"
                      className="text-[11px] text-brand flex items-center gap-1 hover:underline"
                    >
                      <Eye className="w-3.5 h-3.5" /> Preview live form
                    </a>
                  </div>
