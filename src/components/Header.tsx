      ...
      <div className="w-full px-6 flex items-center justify-between">
            ...
            return (
              <Link
                ...
                className={`whitespace-nowrap text-[13px] xl:text-sm font-medium relative px-3 py-1.5 transition-colors duration-300 after:content-[''] after:absolute after:-bottom-0.5 after:left-3 after:right-3 after:h-[2px] after:bg-brand after:rounded-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-left ${
                  isActive ? "text-brand after:scale-x-100 after:bg-brand drop-shadow-[0_0_8px_rgba(67,245,255,0.4)]" : "text-slate hover:text-white"
                }`}
              >
                {item.label}
              </Link>
        ...
        <div className="hidden lg:flex items-center gap-2 xl:gap-3 flex-shrink-0">
          <a
            ...
            className="flex items-center whitespace-nowrap text-[13px] font-medium transition-all duration-300 px-4 py-2 rounded-full border border-line hover:border-brand/40 bg-white/5 text-slate hover:text-white"
          >
        ...
        <button
          ...
          className="lg:hidden p-2 rounded-full focus:outline-none transition-colors text-white hover:bg-white/5 border border-transparent hover:border-line"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 mt-2 bg-glass-card/95 backdrop-blur-xl border border-line rounded-3xl shadow-2xl animate-fade-in py-6 px-5 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="border-t border-line pt-4 flex flex-col space-y-3">
            <a
              href={`tel:${contact.phones[0]}`}
              className="flex items-center justify-center w-full px-4 py-3 rounded-full text-sm font-medium border border-line bg-white/5 text-white hover:bg-white/10 transition-all duration-300"
            >
