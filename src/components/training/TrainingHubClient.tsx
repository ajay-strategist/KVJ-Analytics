  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(350px circle at ${mousePos.x}px ${mousePos.y}px, rgba(16, 185, 129, 0.08), transparent 80%)`,
          opacity: hovered ? 1 : 0,
        }}
      />
...
export function TrainingHubClient({ categories, hub }: TrainingHubClientProps) {
  ...
  return (
    <div className="w-full bg-base text-slate relative min-h-screen pt-28 overflow-hidden text-left">
      ...
      <section className="py-24 relative bg-base-2/40 border-b border-line overflow-hidden">
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-[11px] font-bold uppercase tracking-[0.22em] text-brand">Showcase</span>
            <h2 className="font-display font-bold text-3xl md:text-5xl text-ink mt-3 tracking-tight leading-tight">
              Learning Pathways
            </h2>
            <p className="text-slate font-light mt-4 text-base leading-relaxed">
      ...
      <section ref={journeySectionRef} className="py-24 md:py-32 relative bg-base overflow-hidden border-b border-line">
        <div className="beam absolute top-[30%] left-[-4%] h-[30rem] w-[22rem] bg-brand/5 rounded-full blur-[100px] pointer-events-none" />
        
        <Container className="relative z-10 max-w-[960px]">
          <div className="max-w-2xl mb-20 text-left">
            <span className="text-[11px] font-bold uppercase tracking-[0.22em] text-brand">{hub?.journey?.eyebrow || "Curriculum Flow"}</span>
            <h2 className="font-display font-bold text-3xl md:text-5xl text-ink mt-3 leading-tight tracking-tight">
              {hub?.journey?.heading || "The Learning Journey"}
            </h2>
            <p className="text-slate font-light mt-3 text-sm md:text-base leading-relaxed">
          ...
          <div className="relative pl-0 text-left mt-16 max-w-xl mx-auto">
            {/* Base line track */}
            <div className="absolute left-[23px] sm:left-[27px] top-6 bottom-6 w-[2px] bg-line" />
                  ...
                  <div key={idx} className="relative flex items-start pl-16 sm:pl-24 transition-all duration-500">
                    ...
                    <div 
                      className={`absolute left-0 top-0.5 flex h-12 w-12 sm:h-[56px] sm:w-[56px] items-center justify-center rounded-full border-2 transition-all duration-500 z-10 ${
                        active 
                          ? "border-brand bg-white text-brand shadow-sm scale-100" 
                          : "border-line bg-base-2 text-slate-400 scale-90"
                      }`}
                    >
                      <div className={`absolute -inset-1.5 rounded-full border border-dashed transition-all duration-500 ${
                        active ? "border-brand/20 scale-100" : "border-transparent scale-90"
                      }`} />
                    ...
                    <div className="flex flex-col justify-center select-none pt-1">
                      ...
                      <p className={`mt-1.5 text-xs sm:text-sm font-light leading-relaxed max-w-md transition-colors duration-500 ${
                        active ? "text-slate" : "text-slate-350"
                      }`}>
                        {item.desc}
                      </p>
                    </div>
      ...
      <section className="py-24 relative bg-base-2/40 border-b border-line overflow-hidden">
        <div className="absolute top-[10%] right-[-15%] w-[450px] h-[450px] bg-brand/5 rounded-full blur-[120px] pointer-events-none" />

        <Container>
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-[11px] font-bold uppercase tracking-[0.22em] text-brand">{hub?.tools?.eyebrow || "Ecosystem"}</span>
            <h2 className="font-display font-bold text-3xl md:text-5xl text-ink mt-3 tracking-tight leading-tight">
